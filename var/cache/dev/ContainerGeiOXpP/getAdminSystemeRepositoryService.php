...
// Returns the private 'App\Repository\AdminSystemeRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/AdminSystemeRepository.php';

return $this->privates['App\\Repository\\AdminSystemeRepository'] = new \App\Repository\AdminSystemeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
