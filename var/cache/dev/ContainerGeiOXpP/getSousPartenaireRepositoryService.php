...
// Returns the private 'App\Repository\SousPartenaireRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/SousPartenaireRepository.php';

return $this->privates['App\\Repository\\SousPartenaireRepository'] = new \App\Repository\SousPartenaireRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
