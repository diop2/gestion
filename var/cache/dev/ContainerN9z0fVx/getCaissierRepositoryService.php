...
// Returns the private 'App\Repository\CaissierRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CaissierRepository.php';

return $this->privates['App\\Repository\\CaissierRepository'] = new \App\Repository\CaissierRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
